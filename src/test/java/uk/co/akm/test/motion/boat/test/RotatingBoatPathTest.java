...
public abstract class RotatingBoatPathTest extends BaseBoatPathTest {
    ...
    protected final void rotationOmegaTest(double kLon, double kLatOverKLon, double time, int width, int height) {
        ...
        rotationTest("omega", kLon, kLatOverKLon, factory, time, width, height, imageFileOmegaPath);
    }
    ...
    protected final void rotationVLonTest(double kLon, double kLatOverKLon, double time, int width, int height) {
        ...
        rotationTest("vLon", kLon, kLatOverKLon, factory, time, width, height, imageFileVLonPath);
    }
    ...
    protected final void rotationVLatTest(double kLon, double kLatOverKLon, double time, int width, int height) {
        ...
        rotationTest("vLat", kLon, kLatOverKLon, factory, time, width, height, imageFileVLatPath);
    }

    private final void rotationTest(String name, double kLon, double kLatOverKLon, BoatPathFactory factory, double time, int width, int height, String imageFileName) {
